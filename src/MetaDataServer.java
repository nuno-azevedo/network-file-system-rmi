public class MetaDataServer {
    ...
    public boolean add_storage_server(String host, String top_dir) {
        // Example: add_storage_server("machine1.dcc.fc.up.pt", "/courses");
        return false;
    }

    public boolean del_storage_server(String top_dir) {
        // Example: del_storage_server("/courses");
        return false;
    }

    public boolean add_storage_item(String item) {
        // Example: add_storage_item("/courses/video1.avi");
        return false;
    }

    public boolean del_storage_item(String item) {
